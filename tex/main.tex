...
\usepackage[style=authoryear,sorting=nyt,url=true,arxiv=abs,nohashothers=false, backend=biber, natbib=true, backref=true, dashed=false, isbn=false, eprint=false, date=year, maxcitenames=2]{biblatex} % Controls the bibliography style and sorting.
