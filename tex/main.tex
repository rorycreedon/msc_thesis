...
\usepackage[style=authoryear-comp,sorting=nyt,url=true,arxiv=abs,nohashothers=false, backend=biber, natbib=true, backref=true, dashed=false, isbn=false, eprint=false, date=year, maxcitenames=2]{biblatex} % Controls the bibliography style and sorting.
...
% Literature Review
\include{./sections/literature_review.tex}

% Causal Algo Recourse
\include{./sections/causal_recourse.tex}


% Cost Learning
\include{./sections/cost_learning.tex}
